    ...
    <div class="header-container">
        ...
        <nav class="main-nav" id="main-nav">
            <div class="nav-left-items">
                <a href="index.php"
                    class="<?= strpos($_SERVER['PHP_SELF'], 'index.php') !== false ? 'active' : '' ?>">HOME</a>
                <a href="about-us.php"
                    class="<?= strpos($_SERVER['PHP_SELF'], 'about-us.php') !== false ? 'active' : '' ?>">ABOUT US</a>

                <div class="nav-dropdown">
                    <a href="#" class="dropdown-toggle">PROJECTS <i class="fas fa-chevron-down"
                            style="font-size: 0.8em; margin-left: 3px;"></i></a>
                ...
                <a href="contact-us.php"
                    class="<?= strpos($_SERVER['PHP_SELF'], 'contact-us.php') !== false ? 'active' : '' ?>">CONTACT
                    US</a>
            </div>
        </nav>
...
<div class="mobile-nav" id="mobile-nav">
    ...
    <div class="mobile-actions">
        <a href="tel:+919971199138" class="btn btn-outline mobile-btn"><i class="fa-solid fa-phone"></i> +91 99711
            99138</a>
...
<div id="headerEnquireModal" class="header-modal <?= $show_modal ? 'show' : '' ?>">
    <div class="header-modal-content">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                <textarea name="message" class="header-form-control" placeholder="I am interested in..." rows="3"
                    required></textarea>
            </div>
